...
public class Kunyu77 extends Spider {
    ...
    private String getWebContent(String targetUrl) throws IOException {
        String userAgent = Util.randomUserAgent();
    ...
    public String categoryContent(String tid, String pg, boolean filter, HashMap<String, String> extend) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                JSONObject v = new JSONObject();
                v.put("vod_id", String.valueOf(vObj.getInt("id")));
                v.put("vod_name", vObj.getString("title"));
                v.put("vod_pic", vObj.getString("videoCover"));
                v.put("vod_remarks", vObj.getString("msg"));
                videos.put(v);
    ...
    public String detailContent(List<String> ids) {
        try {
            String url = siteUrl + "/api.php/provide/videoDetail?devid=453CA5D864457C7DB4D0EAA93DE96E67&package=com.sevenVideo.app.android&version=&ids=" + ids.get(0);
            String content = getWebContent(url);
            ...
            vodAtom.put("vod_id", String.valueOf(vObj.getInt("id")));
            ...
            url = siteUrl + "/api.php/provide/videoPlaylist?devid=453CA5D864457C7DB4D0EAA93DE96E65&package=com.sevenVideo.app.android&version=&ids=" + ids.get(0);
